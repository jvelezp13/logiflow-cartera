-- ============================================
-- Quitar filtro WHERE num_facturas > 0
-- La vista ahora incluye TODOS los clientes de maestra_total,
-- tengan o no facturas. Esto permite que la pagina de detalle
-- funcione para clientes con cupo sin uso y credito anulado.
-- Los COALESCE existentes ya manejan los NULL (0 facturas, 0 deuda, etc.)
-- ============================================
